...
const DepartmentsPage = () => {
  ...
  const [goToValue, setGoToValue] = React.useState("https://www.google.com/maps/embed/v1/place?API_KEY=&q=")
  ...
  return (
    <>
      {Banner({ title: "Departments", subtitle: "Understand what the government is doing for you", quote: "Who deserves more credit than the wife of a coal miner?", author: "Merle Travis" })}
      <Flex flexDirection="column" justifyContent="center" alignItems="center">
        ...
        <Flex className="map-recommender" flexDir="column" justifyContent="center" alignItems="center">
          <Box m="20">
            <Heading mb="1rem">Need to go somewhere?</Heading>
            <Divider mb="2rem" />
            <FormControl>
              <FormLabel>We'll recommend a place for you to get your things sorted.</FormLabel>
              <Flex justifyContent="center" alignItems="center" flexDir="column">
                <Input placeholder="Tell me where you want to go" onChange={handleChangeGoToValue} />
                <Button
                  mt={4}
                  colorScheme="teal"
                  type="submit"
          ...
          <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d16687.156700646265!2d151.23325406570711!3d-33.91151570101442!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x6b129838f39a743f%3A0x3017d681632a850!2sSydney%20NSW!5e0!3m2!1sen!2sau!4v1627704530940!5m2!1sen!2sau"

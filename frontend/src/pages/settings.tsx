...
const Option = (title: string, subtitle: string, content?: any) => {
  ...
  return (
    <Flex flexDir="column">
      <PopupMenu show={show} {...{ title: title, content: content, onHide: handleClose }} />
      <Text textAlign="center" mb="1rem" color="#152154" fontSize="1.5rem">{title}</Text>
      <motion.div onClick={handleShow} style={{ cursor: "pointer" }} whileHover="hoverfour" variants={LogoAnimateVariants}>
        <Text textAlign="center" mb="1rem">{subtitle}</Text>
      </motion.div>
    </Flex>
  )
}
...
const SettingsPage = (props: Props) => {
  ...
  return (
    <Flex m="4rem" flexDir="column">
      <Flex className="heading-container" justifyContent="center" alignItems="center" flexDir="column" mb="1rem">
        <Heading textAlign="center" mb="1rem">Settings</Heading>
        <Divider width='50%' />
      </Flex>

      <Flex className="home-cards" justifyContent="center" alignItems="center" flexDir="column">
        {Option("Password", "Change your password", (<>
          <Text mb="2.5rem">
            Want to change your password?<br />
        ...
        <Divider width='50%' />
        {Option("Email Address", "Change the email address linked to your account", (<>
          <Text mb="0.5rem">
            Changing your email?
          </Text>
          <Text mb="2.5rem">
        ...
        <Divider width='50%' />
        {Option("Email Notifications", "Customize what information and updates you recieve", (
          <>
            <Text mb="0.5rem">
              Want notifications?
            </Text>
            <Text mb="2.5rem">
              Toggle your options below.
            </Text>
        ...
        <Divider width='50%' />
        {Option("Dark Mode", "Change to Light or Dark Mode depending on your preferences")}

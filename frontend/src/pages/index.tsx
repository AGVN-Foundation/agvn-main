        ...
        >
          ...
          <Flex alignItems="center" justifyContent="center" mb="1rem">
            <Text m="2.5rem" maxW="25rem">
              ...
              <br />
              Here you can browse our initiatives that are generated based on
              everyone's interests. Vote for initiatives, grow your contribution
              and complete polls to enhance the system. Learn about what AGVN is
              doing for you!
              <br />
          ...
          <Text ml="10rem" className="Note" fontSize="10pt">
            Note: to vote you must have an account with A-GVN Services.
          </Text>
        </Flex>

...
const MotionHeading = (component: any) => <motion.div>{component}</motion.div>
  ...
  return (
    <Flex className="banner" backgroundColor="#282A2B" color="#D3D3D3" p="5rem">
      <Flex className="title-pane" flexDir="column" w="50%" alignItems="center">
        <motion.div
          whileHover={{ color: "#782020", transition: { spring: Infinity } }}
        >
  ...
  return (
    <header>
      <Navbar
        ...
        variant={navColor}
        expand="lg"
        className="flex-column space-evenly"
      >
        <Container style={{ paddingBottom: 0 }}>
          ...
          <Nav style={{ fontSize: 12, paddingBottom: 0 }}>
        ...
        <Container>
          <Nav>
            <motion.div
              whileHover={{ skew: 20, transition: { yoyo: Infinity } }}
            >
              <Nav.Link onClick={toHome} style={{ fontSize: 12 }}>
          ...
          <Nav className="ml-auto">
            ...
            {auth && (
              <Nav.Link onClick={toNotifications}>
                <Bell size={25} />
              </Nav.Link>
            )}
          </Nav>
        ...
        <Container>
          ...
          <Navbar.Collapse id="responsive-navbar-nav">
            <Nav justify style={{ width: "80%" }}>
              ...
              <NavDropdown
                title="Others"
                id="collaible-nav-dropdown"
                className="navhover"
                style={{ backgroundColor: "#333333" }}
              >
                <NavDropdown.Item onClick={toDepartments}>
                  Departments
                </NavDropdown.Item>
                <NavDropdown.Item onClick={toInitiative}>
                  Initiatives
                </NavDropdown.Item>
            ...
            <Nav className="ms-auto">
              {!auth && <Nav.Link onClick={toSignin}>Login</Nav.Link>}
              {auth && (
                <Nav.Link onClick={toProfile}>
                  <Person size={25} />
                </Nav.Link>
              )}
              {auth && (
                <Nav.Link onClick={toSetting}>
                  <motion.div
              ...
              <Nav.Link
                onClick={() => {
                  setNavColor(navColor == "dark" ? "light" : "dark")
                }}
              >
                <motion.div

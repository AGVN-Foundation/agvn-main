...
education_levels = ['Certificate I', 'Certificate II', 'Certificate III', 'Certificate  IV', 'Diploma', 'Advanced Diploma', 'Associate Degree', 'Bachelor Degree', 'Bachelor Honours', 'Graduate Certificate', 'Graduate Diploma', 'Masters Degree', 'Doctoral Degree']
...
for i in range(0, 500):
  ...
  address = fake.building_number() + ' ' + fake.street_name() + ' ' + fake.city() + ', ' + fake.state_abbr()
